package com.aaron.gunserver.repository;

import com.aaron.gunserver.GunServerApp;

import com.aaron.gunserver.config.Constants;
import com.aaron.gunserver.config.audit.AuditEventConverter;
import com.aaron.gunserver.domain.PersistentAuditEvent;
...
import static com.aaron.gunserver.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
